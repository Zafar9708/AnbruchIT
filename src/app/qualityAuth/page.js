        ...
        <div className="container px-0 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            {[
              ...
              <div key={index} className="bg-blue-950 p-12 rounded-lg shadow-lg transition-transform transform hover:scale-105" data-aos="zoom-in-up">
                <div className="flex justify-center mb-4">
                  <img src={service.imgSrc} alt={service.title} className="w-60 h-40" />
                </div>
        ...
        <div className="container mx-auto px-4 text-center" data-aos="zoom-in-up">
          ...
          <div className="flex flex-wrap justify-center gap-12">
            ...
            {[
              ...
              <div key={index} className="bg-blue-50 p-8 rounded-lg max-w-xs">
                <h3 className="text-2xl font-semibold mb-4 text-gray-950">{insight.title}</h3>
                <p className="text-gray-950 mb-4">{insight.description}</p>
              </div>
            ))}
          </div>
        </div>
