  ...
  return (
    <div ref={sectionRef} className="py-12 px-6 bg-gray-50 mb-5" data-aos="zoom-in-up">
      ...
      <div className="flex justify-between">
        ...
        <div className="w-1/4 bg-blue-950 border border-gray-200 shadow-lg rounded-lg overflow-hidden transform transition-transform duration-300 hover:shadow-xl hover:scale-105" data-aos="zoom-in-up">
          <div className="p-12">
