                ...
                <div className="container mx-auto" data-aos="zoom-in-up">
                    ...
                    <div className="flex flex-wrap gap-6 mb-4 text-center">
                        ...
                        <Link href='/card1' legacyBehavior>
                            <a className="relative bg-blue-50 text-black rounded-lg border border-gray-200 shadow-md hover:shadow-xl transition-shadow duration-300 flex-1 group w-full sm:w-1 lg:w-1 xl:w-1 h-[250px] md:h-[300px] lg:h-[350px] flex items-center justify-center">
                        ...
                        <a className="relative block bg-blue-50 text-black rounded-lg border border-gray-200 shadow-md hover:shadow-xl transition-shadow duration-300 flex-1 group w-full sm:w-1 lg:w-1 xl:w-1 h-[250px] md:h-[300px] lg:h-[350px] items-center justify-center">
                        <div className="p-6 text-center">
                                    <h2 className="text-xl font-semibold  mt-14 mb-4">Design & Build</h2>
                                    <p className="text-black">
